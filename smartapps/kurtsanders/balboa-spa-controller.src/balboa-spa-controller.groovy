...
String DTHDNI() { return "${app.id}:BalboaSpaControl" }
String appVersion()	 { return "1.0" }
String appModified() { return "2019-02-03" }
String appAuthor()	 { return "Kurt Sanders" }
Boolean isST() { return (platform() == "SmartThings") }
String getAppImg(imgName) { return "https://raw.githubusercontent.com/KurtSanders/Balboa-Spa-Control-Manager/master/smartapps/kurtsanders/balboa-spa-control-manager.src/$imgName" }

definition(
    name: 		"Balboa Spa Controller",
    namespace: 	"kurtsanders",
    author: 	"Kurt@KurtSanders.com",
    description:"Control and monitor your Bullfrog/Balboa® Spa via a direct WiFi connection anywhere using SmartThings®",
    category: 	"My Apps",
    iconUrl: 	getAppImg("SpaController.png"),
    iconX2Url: 	getAppImg("SpaControllerX2.png"),
    iconX3Url: 	getAppImg("SpaControllerX3.png"),
    singleInstance: true
)
